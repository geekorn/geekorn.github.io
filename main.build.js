...
function closePopup() {
  popup.classList.remove('popup_open'); // document.body.style = 'overflow: visible';
}

function openQuestion(e) {
  var target = e.currentTarget;
  var parent = target.parentElement;
  parent.classList.toggle('faq__item_open'); // document.body.style = 'overflow: hidden';
} // console.log('popupButtons', popupButtons);


popupButtons.forEach(function (button) {
  return button.onclick = openPopup;
});
